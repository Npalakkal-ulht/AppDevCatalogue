...
namespace Login
{
    public static class LoginConfig
    {
        ...
        public static readonly string[] DevAccessGroups = { OpenAccessNoGroup };                        // development access groups
        public static readonly string[] LiveAccessGroups = { OpenAccessNoGroup };                       // live access groups
